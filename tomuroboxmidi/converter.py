...
def convert(
    ...
    filtered, removed_range = _remove_out_of_range(merged, valid_notes)
    deduped, removed_dups = _remove_duplicates(filtered)
    ...
    return ConvertResult(
        removed_out_of_range=removed_range,
...
def _remove_duplicates(messages: list) -> tuple[list, int]:
